...
public class LoggingServiceImpl<T> implements LoggingService {
    ...
    private volatile T thisMember = null ; //TODO set the instance
    private volatile String thisAddressString = "[LOCAL]"; //TODO how to deal with this ?
    ...
    public void setThisMember(T thisMember) {
